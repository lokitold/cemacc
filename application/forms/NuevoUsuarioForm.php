...
class Application_Form_NuevoUsuarioForm extends Core_Form {
    ...
    function init() {
        ...
        $usuario->addFilter(new Zend_Filter_StripTags())
                ...
                ->addValidator(new Application_Form_Validators_UniqueUsuarioLogin, true);
        ...
        $nroDocumento->addFilter(new Zend_Filter_StripTags())
                ...
                ->addValidator(new Application_Form_Validators_UniqueUsuarioDocumento, true)
                ->setRequired(true);
