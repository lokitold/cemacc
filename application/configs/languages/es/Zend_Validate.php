...
return array(
    ...
    "Invalid type given, value should be a string" => "El tipo especificado no es válido, el valor debe ser una cadena de texto",
    "'%value%' is no valid email address in the basic format local-part@hostname" => "'Correo invalido, el formato adecuado es: ejemplo@clasificados.pe",
...
// Zend_Validate_GreaterThan
    ...
    "No token was provided to match against" => "No se ha especificado ningun dato a comprobar",
    ...
    "Value is required and can't be empty" => "Este Campo es obligatorio",
    ...
    //Email not valide
    "'%value%' is not a valid email address in the basic format local-part@hostname" => "Email debe tener formato: usuario@mail"
